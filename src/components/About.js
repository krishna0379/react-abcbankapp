          ...
          <CardDeck>
            <Card className="">
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Whether you are opening your first bank account or have
                  managed a checking account for years, it helps to know the
                  different types of banking services available. This ensures
                  you get the most out of your current financial institution.
                  Deciding which services are most important can lead you to the
                  bank that best fits your needs.
                  <br />
                  <br />
                  <p>
            ...
            <Card>
              ...
              <Card.Body className="alert alert info">
                ...
                <Card.Text>
                  We take data privacy seriously so that our users feel
                  empowered to share honest and constructive feedback and
                  consequently, continuous feedback is sent only to the
